...
def f_beta(epoch, args):
    ...
    beta3 = np.linspace(args.max_beta, args.max_beta, num=args.rounds1 * args.local_ep)
...
def adjust_learning_rate(epoch, args, optimizer=None):
    ...
    alpha_plan = [[args.plr] * int(args.local_ep * args.rounds1/2) + [args.plr] * args.local_ep * args.rounds1,
                  [args.lr] * int(args.local_ep * args.rounds1/2) + [args.lr] * args.local_ep * args.rounds1]
    # else:
