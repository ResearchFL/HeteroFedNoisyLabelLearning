...
def FedTwin(args):
    ...
    for rnd in range(args.rounds2):
        ...
        for idx in idxs_users:  # training over the subset
            ...
            w_locals.append(w_local)  # store every updated model
        ...
        w_glob_fl = personalized_aggregation(netglob.state_dict(), w_locals, n_bar,  args.beta)
        ...
        show_info = "third stage round %d, global test acc  %.4f \n" % (rnd, acc_s2)
        print(show_info)
