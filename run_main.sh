...
nohup bash python -u main.py --alg FedTwin_fi --dataset mnist --model lenet --rounds1 200 --rounds200  --num_users 100 --lr 0.1 --plr 0.1 --frac2 0.1 --begin_sel 10 --gpu 0 --level_n_system 0.5 --level_n_lowerb 0.3 --iid
